<script>
    ...
    import {Avatar, Dropdown, DropdownDivider, DropdownHeader, DropdownItem, Footer, FooterCopyright, FooterLink, FooterLinkGroup, Navbar, NavBrand, NavHamburger, NavLi, NavUl, Sidebar, SidebarGroup, SidebarItem, SidebarWrapper} from "flowbite-svelte";
    import {ArrowRightToBracketSolid, ChartPieSolid, FileEditSolid, GridSolid, MailBoxSolid, UserSolid} from "flowbite-svelte-icons";
...
<Navbar class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <NavBrand href="/">
        <img src="https://flowbite-admin-dashboard.vercel.app/images/logo.svg" class="me-3 h-6 sm:h-9" alt="Flowbite Logo" />
...
<div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
    ...
    <Sidebar class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" >
        <SidebarWrapper class="bg-white">
            <SidebarGroup>
                ...
                <SidebarItem label="Kanban" {spanClass} href="#/Kanban">
                    <svelte:fragment slot="icon">
                ...
                <SidebarItem label="Inbox" {spanClass} href="#/Inbox">
                    <svelte:fragment slot="icon">
            ...
            <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700" id="language-dropdown" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(184px, 574px);" data-popper-placement="bottom">
